...
<li> -pid - Definiuje PID procesu który chcemy zaatakować.</li>
...
<li> -freeze - Zamraża wątki powodujące wyjątek dostępu do pamięci w atakowanym procesie.</li>
<li> -trampoline (bardzo stablina) - Umieszcza wstrzykiwany kod w obszarze funkcji startowych atakowanego procesu, a pod adresem ntdll!DbgBreakPoint umieszcza tylko skok do 
     _IMAGE_OPTIONAL_HEADER.AddressOfEntryPoint.<br/>
...
<li> -cave (nie zaimplementowana) - Umieszcza wstrzykiwany kod w przestrzeni między sekcjami kodu biblioteki ntdll.dll, również jest bardzo stabilna i ponadto umożliwia 
